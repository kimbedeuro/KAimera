...
MTS_cad_SWaT_1 = pd.read_csv("Dataset/SWaT/1_MTS_CAD_prediction_score.csv")
MTAD_gat_2 = pd.read_csv("Dataset/SWaT/2_mtad_gat_prediction_score.csv")
GANF_3 = pd.read_csv("Dataset/SWaT/3_ganf_prediction_score.csv")
ANOMALY_transformer_4 = pd.read_csv("Dataset/SWaT/4_anomaly_transformer_prediction_score.csv")
RANSynCoder_5 = pd.read_csv("Dataset/SWaT/5_RANS_prediction_score.csv")
Autoencoder_6 = pd.read_csv("Dataset/SWaT/6_autoencoder_prediction_score.csv")
USAD_7 = pd.read_csv("Dataset/SWaT/7_usad_prediction_score.csv")
GDN_8 = pd.read_csv("Dataset/SWaT/8_gdn_prediction_score.csv")
LSTM_9 = pd.read_csv("Dataset/SWaT/9_lstm_prediction_score.csv")
MSCRED_10 =pd.read_csv("Dataset/SWaT/10_mscred_prediction_score.csv")
