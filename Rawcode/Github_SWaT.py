...
Training_SWaT_RAW = pd.read_csv("SWaT_Dataset_Normal_v1.csv") 

TEST_SWaT_RAW = pd.read_csv("SWaT_Dataset_Attack_v0.csv") 
...
teacher_model.load_state_dict(torch.load(f'Teacher_model_trial_{trial_num}.pth'))
teacher_model.eval()
