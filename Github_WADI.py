...
#for batch in dataset_zip.take(1):
...
#torch.save(student_model.state_dict(), '/home/bedro/000_KD/WADI_teacher_student/WADI_student_MSE_model.pt')


#student_model.load_state_dict(torch.load("/home/bedro/000_KD/WADI_teacher_student/WADI_student_MSE_model.pt"))
